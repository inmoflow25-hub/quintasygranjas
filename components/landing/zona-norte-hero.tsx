...
export function ZonaNorteHero({ onWhatsAppClick }: ZonaNorteHeroProps) {
  ...
  return (
    <section className="relative min-h-screen flex items-center pt-20 overflow-hidden">
      ...
      <div className="absolute top-0 left-0 w-full z-20 bg-green-600 text-white text-sm text-center py-2">
        🚚 Zona Norte · 🧺 Pedido mínimo $20.000 · 🎁 Completá el objetivo de tu barrio y desbloqueá 10% OFF
      </div>
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-2xl">
          ...
          <p className="mt-6 text-lg md:text-xl text-white/90 leading-relaxed max-w-xl">
            Elegí tu zona, armá tu pedido y sumá al objetivo semanal de tu barrio.
          </p>
